...
public class BootstrapFeedbackPanel extends Panel implements IFeedback
{
	...
	/** Message view */
	private final BootstrapFeedbackPanel.MessageListView messageListView;
	...
	public BootstrapFeedbackPanel(final String id, IFeedbackMessageFilter filter)
	{
		...
		messageListView = new BootstrapFeedbackPanel.MessageListView("messages");
